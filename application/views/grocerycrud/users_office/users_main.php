...
<head>
    ...
    <title>Users UI - Affectation Management Application</title>
...
<header>
    <!-- Navbar -->
    <nav class="navbar navbar-expand-md fixed-top app-header navbar-light unique-color white-text">
                        ...
                        <ul class="dropdown-menu settings-menu dropdown-menu-right  text-center">
                            ...
                            <li class="dropdown-item  text-center">
                                <a tabindex="0" class="btn btn-link"
                                   href="<?= base_url('appMain/monProfil'); ?>">Mon profil</a>
                            </li>
                            <li class="dropdown-item  text-center">
    ...
    <aside class="position-fixed app-sidebar unique-color white-text fixed-top mt-0 pt-0" id="sidebar">
        <div class="mt-1 pt-1">
            <a href="<?php echo base_url('AppMain/index'); ?>" class="waves-effect text-center">
                <img src="<?= base_url() ?>resources/front/img/avatar.png" alt="Logo App"
                     class="img-fluid w-50 h-50">
                <br>
                <span class="text-capitalize font-weight-bold white-text">
        ...
        <div class="list-group list-group-flush unique-color white-text">
            <h5 class="grey-text mt-2 pt-2 ml-2">Menu utilisateur</h5>
            <!-- Preferences rubrique -->
            <a href="<?php echo base_url('appMain/dashboard'); ?>"
               class="list-group-item list-group-item-action waves-effect small unique-color white-text
           <?php echo (uri_string() == 'appMain/dashboard') ? "active" : ""; ?>">
                <i class="fa fa-dashboard"></i> <strong> Vue d'ensemble</strong></a>
            <?php
            if ($this->session->job == 'Archeveque') { ?>
                <a class="list-group-item list-group-item-action waves-effect small unique-color white-text <?php echo (uri_string() == 'appMain/pretres') ? "active" : ""; ?>"
                   href="<?php echo base_url('appMain/pretres'); ?>">
                    <i class="fa fa-users"></i> <strong>Pretres</strong></a>
                <a class="list-group-item list-group-item-action waves-effect small unique-color white-text <?php echo (uri_string() == 'appMain/paroisses') ? "active" : ""; ?>"
                   href="<?php echo base_url('appMain/paroisses'); ?>">
                    <i class="fa fa-building"></i> <strong>Paroisses</strong></a>

                <!-- Mes proches rubrique -->
                <a href="<?php echo base_url('appMain/affectations'); ?>"
                   class="list-group-item list-group-item-action waves-effect small unique-color white-text
           <?php echo (uri_string() == 'appMain/affectations') ? "active" : ""; ?>">
                    <i class="fa fa-newspaper-o"></i> <strong>Affectations</strong></a>
                <!-- Mes proches rubrique -->
                <a href="<?php echo base_url('appMain/lettresReadonly'); ?>"
                   class="list-group-item list-group-item-action waves-effect small unique-color white-text
           <?php echo (uri_string() == 'appMain/lettresReadonly') ? "active" : ""; ?>">
                    <i class="fa fa-envelope"></i> <strong>Lettres</strong></a>
                <!-- Mes proches rubrique -->
                <a href="<?php echo base_url('appMain/mouvements'); ?>"
                   class="list-group-item list-group-item-action waves-effect small unique-color white-text
           <?php echo (uri_string() == 'appMain/mouvements') ? "active" : ""; ?>">
                    <i class="fa fa-bookmark-o"></i> <strong>Mouvements</strong></a> <!-- Mes proches rubrique -->
            <?php } elseif ($this->session->job == 'Chancelier') { ?>
                <!-- Mes proches rubrique -->
                <a href="<?php echo base_url('appMain/lettres'); ?>"
                   class="list-group-item list-group-item-action waves-effect small unique-color white-text
           <?php echo (uri_string() == 'appMain/lettres') ? "active" : ""; ?>">
                    <i class="fa fa-envelope"></i> <strong>Lettres</strong></a>
                <a href="<?php echo base_url('appMain/affectationsReadonly'); ?>"
                   class="list-group-item list-group-item-action waves-effect small unique-color white-text
                <?php echo (uri_string() == 'appMain/affectationsReadonly') ? "active" : ""; ?>">
                    <i class="fa fa-newspaper-o"></i> <strong>Affectations</strong></a>
                <!-- Mes proches rubrique -->
                <a href="<?php echo base_url('appMain/mouvementsReadonly'); ?>"
                   class="list-group-item list-group-item-action waves-effect small unique-color white-text
           <?php echo (uri_string() == 'appMain/mouvementsReadonly') ? "active" : ""; ?>">
                    <i class="fa fa-bookmark-o"></i> <strong>Mouvements</strong></a> <!-- Mes proches rubrique -->
                <a class="list-group-item list-group-item-action waves-effect small unique-color white-text
                <?php echo (uri_string() == 'appMain/pretresReadonly') ? "active" : ""; ?>"
                   href="<?php echo base_url('appMain/pretresReadonly'); ?>">
                    <i class="fa fa-users"></i> <strong>Pretres</strong></a>
                <a class="list-group-item list-group-item-action waves-effect small unique-color white-text
                <?php echo (uri_string() == 'appMain/paroissesReadonly') ? "active" : ""; ?>"
                   href="<?php echo base_url('appMain/paroissesReadonly'); ?>">
                    <i class="fa fa-building"></i> <strong>Paroisses</strong></a>
                <!-- Mes proches rubrique -->
                <a href="<?php echo base_url('appMain/lettresReadonly'); ?>"
                   class="list-group-item list-group-item-action waves-effect small unique-color white-text
           <?php echo (uri_string() == 'appMain/lettresReadonly') ? "active" : ""; ?>">
                    <i class="fa fa-print"></i> <strong>Impression Lettres</strong></a>
            <?php } ?>

            <div class="dropdown">
                <a class="list-group-item list-group-item-action dropdown-toggle small unique-color white-text
            <?php
                ...
                <div class="dropdown-menu dropdown-primary" aria-labelledby="navbarDropdownMenuLink">
                    <a class="dropdown-item font-weight-bold small <?php echo (uri_string() == 'admin/cabinet') ? "active" : ""; ?>"
                       href="<?php echo base_url('appMain/monProfil'); ?>">
                        <i class="nav-link-icon fa fa-user"></i> Mon compte</a>
                    ...
                    <div class="d-lg-none">
                        <a class="dropdown-item font-weight-bold small <?php echo (uri_string() == 'admin/patient') ? "active" : ""; ?>"
                           href="<?php echo base_url('admin/patient'); ?>">
                            <i class="nav-link-icon fa fa-globe"></i> Configuration</a>
