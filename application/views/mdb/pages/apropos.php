...
<main role="main" class="pt-5 mt-5">
    ...
    <div class="pt-5">
        ...
        <section class="unique-color white-text">
            <div class="container">
                ...
                <div class="row wow fadeIn">
                    ...
                    <div class="col-lg-6 col-md-12 px-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-10">
                                <h5 class="feature-title">Enquetes </h5>
                                <p>Thanks to MDB you can take advantage of all feature of newest Bootstrap
                                    4.</p>
                            </div>
                        </div>
                        <!--/First row-->
                        ...
                        <div class="row">
                            ...
                            <div class="col-10">
                                <h5 class="feature-title">Recherches</h5>
                                <p>We give you detailed user-friendly documentation at your disposal. It
                        ...
                        <div class="row">
                            ...
                            <div class="col-10">
                                <h5 class="feature-title">Etude</h5>
                                <p>We care about the development of our users. We have prepared numerous
                    ...
                    <div class="col-lg-6 col-md-12">
                        ...
                        <p class="h5 text-center mb-4">Vous pouvez visualiser cette courte video pour plus d'explication
                            sur
                            le fonctionnement de notre organisation</p>
        ...
        <section class="container">
            ...
            <h2 class="my-5 h3 text-center">En savoir plus l'organe de notre organisation ?</h2>
            ...
            <div class="row features-small mb-5 mt-3 wow fadeIn">
                ...
                <div class="col-md-4 flex-center">
                    <img src="<?= base_url('resources/'); ?>logo/crisc_logo.jpg" alt="Emission image"
                         class="img-fluid z-depth-0 w-100">
                </div>
                <!--/Second column-->
        ...
        <!--Section: More-->
        <section class="unique-color-dark white-text">
            <div class="container-fluid">


            <h2 class="my-5 h3 text-center">...Plus encore de services corporates tailles sur-mesure.</h2>
            ...
            <div class="row features-small mt-5 wow fadeIn">
                ...
                <div class="col-xl-4 col-lg-6">
                    ...
                    <div class="row">
                        <div class="col-2">
                            <i class="fa fa-level-up-alt fa-2x mb-1 indigo-text" aria-hidden="true"></i>
                        </div>
            ...
            <div class="row features-small mt-4 wow fadeIn">
                ...
                <div class="col-xl-4 col-lg-6">
                    ...
                    <div class="row">
                        <div class="col-2">
                            <i class="fa fa-file-code fa-2x mb-1 indigo-text" aria-hidden="true"></i>
                        </div>
                        <div class="col-10 mb-2">
